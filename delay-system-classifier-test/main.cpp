...
int main(int argc, char const *argv[])
{
	...
	*/
	...
	// vectors to track training accuracy and validition accuracy:
	...
	print_results(results_file_name, training_accuracy_vector, accuracy_vector);
