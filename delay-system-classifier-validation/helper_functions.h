...
void print_parameters(std::string results_file_name, std::string print_msg, std::string task, bool cross_validation, std::string system_simu, double theta, double alpha, int number_of_epochs, double eta_0, double eta_1, int N_h, double exp_precision);
void print_results(std::string results_file_name, int validation_batch_index, std::vector<double> training_accuracy_vector, std::vector<double> accuracy_vector);
