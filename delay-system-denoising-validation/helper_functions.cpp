						...
						double initial_input_weigt_radius, double initial_first_hidden_weigt_radius, double initial_second_hidden_weigt_radius, double initial_output_weigt_radius, bool save_to_file)
{
	...
	second_conv_hidden_weights:
						reference to arma field of #second_conv_output_channels * #second_conv_input_channels * K * K
						To be filled with intitial weights for the second convolution operation

	first_hidden_weights_mat:
						reference to arma mat of size #first_conv_output_channels*M * M
						To be filled by unrolling the initialized first_conv_hidden_weights

	second_hidden_weights_mat:
						reference to arma mat of size #second_conv_output_channels*M * #first_conv_output_channels*M
...
void print_parameters(string results_file_name, string print_msg, string task, bool cross_validation, string system_simu, double theta, double alpha,
...
void print_results(string results_file_name, int validation_batch_index, vector<double> training_accuracy_vector, vector<double> accuracy_vector)
{
	/*
